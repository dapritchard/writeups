...
Quasiquotation (sometimes known as backquoting) is the ability to quote an
expression, but selectively evaluate portions of an expression.

  * Suppose we know the form of the expression but there are some parts that are
    not known in advance.
  * `bquote` takes an expression and replaces any terms of the form
    `.(mysymbol)` with the result of evaluating the expression inside the
    parentheses.
