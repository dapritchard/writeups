...
The rlang library provides several alternatives for quotation.
  ...
  * `rlang::exprs` is similar to `expression`, except that it returns
    a list of expressions rather than an expression vector (this is a stated
    design choice by the library's creators).
